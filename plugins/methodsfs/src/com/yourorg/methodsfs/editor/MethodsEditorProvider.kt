...
private class MethodsListEditor(
  ...
  init {
    com.intellij.openapi.project.DumbService.getInstance(project).runWhenSmart { panel.refresh() }
  }

  override fun getComponent(): javax.swing.JComponent = panel
  override fun getPreferredFocusedComponent(): javax.swing.JComponent = panel
